...
class PaymentControllerTest {
    ...
    @Test
    void savePayment_Amount_BadRequest() throws Exception {
    ...
    @Test
    void savePayment_Description_BadRequest() throws Exception {
    ...
    @Test
    void savePayment_Currency_BadRequest() throws Exception {
    ...
    void getAllPayments_Success() throws Exception {
        ...
        //Assert
        verify(paymentService, times(2)).getAllPayments(1, 5, new PaymentCriteria());
    }
